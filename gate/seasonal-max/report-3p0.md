...
- timesfm-3.0 has no published corpus manifest; PEGELONLINE is open and CAMELS-DE (2024) covers German basins. Assume the archive MAY be in the training data. A7 is a probe, not a proof — and it gets weaker the later the checkpoint, because A7's own recent side (2024-2025) can sit inside the training window too.
